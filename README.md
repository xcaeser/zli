...
[![Version](https://img.shields.io/badge/ZLI-v4.0.2-green)](https://github.com/xcaeser/zli/releases)
...
- Spinners (new in v4.0.2 - experimental)
- Usage hints, context-aware

## 📦 Installation

```sh
zig fetch --save=zli https://github.com/xcaeser/zli/archive/v4.0.2.tar.gz
```
