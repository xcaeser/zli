...
[![Version](https://img.shields.io/badge/ZLI-v3.1.3-green)](https://github.com/xcaeser/zli/releases)
...
```sh
zig fetch --save=zli https://github.com/xcaeser/zli/archive/v3.1.3.tar.gz
```
